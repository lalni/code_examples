...
public partial class InstrumentExecutor : InstrumentExecutorBase
{
    ...
    //    public lasso(double[] a, double[] x,
    //                  double[] y, double[] z, int iterations, double learning_rate,double penalty)
    //    {
    //        this.a = a;
    //        this.x = x;
    //        this.y = y;
    ...
    //        double[][] x1 = { this.a, this.x, this.y };
    //        Matrix X1 = (Matrix)DenseMatrix.OfRowArrays(x1).Transpose();
    //        double[][] x2 = { this.x, this.y, this.z };
    //        Matrix X2 = (Matrix)DenseMatrix.OfRowArrays(x2).Transpose();
    ...
    //        DenseVector Y1 = DenseVector.OfArray(z);
    //        DenseVector Y2 = DenseVector.OfArray(a);
    //        DenseVector b = new DenseVector(29);
    //        DenseVector W = new DenseVector(29);
    //        this.X = X3;
    //        this.Y = Y3;
    //        this.b = b;
    //        this.W = W;
    //        this.m = X3.RowCount;
    //        this.n = X3.ColumnCount;
    ...
    //    public double update_weights()
    //    {
    //        DenseVector ww = new DenseVector(29);
    //        DenseVector y_pred = (DenseVector)this.X.Multiply(this.W).Add(this.b);
    ...
    //            {
    //                Matrix tempV =  (Matrix) this.X.SubMatrix(0, this.n, i, 1);
                   
    //                Flatten(tempV)

    //                DenseVector vv = DenseVector.OfArray(tempV);
    //                ww[i] = (-1 * (2 * vv.ConjugateDotProduct(this.Y.Subtract(y_pred))) + this.penalty) / this.m;
    //            }
